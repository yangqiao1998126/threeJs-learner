<template>
  <div id="app">
    ...
    <section v-if="this.$route.path==='/three1'" class="infoContainer" @click.stop>
      ...
      <div ref="echartsContainer" class="echarts-container-left">
        <EchartsContainer @hideLeft="$refs.echartsContainer.style.left = '-30%';isShowOpenIcon = true"></EchartsContainer>
      </div>
      <img
      ...
      >
      <!--      <div class="echarts-container-right">-->
